...
public class TVSeasons {
    ...
    /**
     * <p>Get the external ids for a TV season. We currently support the following external sources.</p>   
     * <strong>Media Databases</strong>     TVDB ID   Freebase MID*   Freebase ID*   TVRage ID*   
    ...
    /**
     * <p>Get the videos that have been added to a TV season.</p>
     * <a href="https://developers.themoviedb.org/#recent-changes">\ud83d\udd17</a> Recent Changes    <strong>Date</strong> <strong>Change</strong>     March 23, 2019 Vimeo was added as a video source.   March 20, 2019 "Behind the Scenes" and "Bloopers" and "Recap" were added as valid video types.
     * 
     * @param language
     *     Pass a ISO 639-1 value to display translated data for the fields that support it.
     * @param seasonNumber
