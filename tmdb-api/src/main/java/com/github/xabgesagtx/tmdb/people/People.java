...
public class People {
    ...
    /**
     * <p>Get the external ids for a person. We currently support the following external sources.</p>   
     * <strong>External Sources</strong>     IMDB ID   Facebook   Freebase MID   Freebase ID   Instagram   TVRage ID   Twitter
     * 
     * @param language
     *     Pass a ISO 639-1 value to display translated data for the fields that support it.
     * @param personId
